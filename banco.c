...
// Função: criarConta
// Responsável por cadastrar uma nova conta no banco, garantindo número único e saldo inicial válido
...
// Função: realizarSaque
// Efetua saque em uma conta existente, validando saldo e valor positivo.
...
// Efetua depósito em uma conta existente, validando valor positivo.
...
// Função: exibirListaConta
// Lista todas as contas cadastradas no banco com seus respectivos dados.
